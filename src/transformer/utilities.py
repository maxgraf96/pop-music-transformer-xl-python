# =============================================
# This file contains the utility code used for the generation of REMI data
# NOTE: The contents of this file are taken from https://github.com/YatingMusic/remi
# =============================================
...
def write_midi(words, word2event, output_path, prompt_path=None, counter=0):
    ...
    # Try dumping in frontend as well (doesn't work on server)
    try:
        dir = os.path.dirname(__file__)
        filename = os.path.join(dir, '../../../CC_Project_Frontend/midi/generated_' + str(counter) + '.mid')
        from shutil import copyfile
        copyfile(output_path, filename)
    except Exception:
        print("Couldn't write midi to frontend folder. Probably not on server")
